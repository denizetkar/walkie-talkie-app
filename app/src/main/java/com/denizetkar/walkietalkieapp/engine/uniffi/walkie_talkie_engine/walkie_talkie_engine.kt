...
package uniffi.walkie_talkie_engine
   ...
   internal fun setValue(other: RustBuffer) {
    ...
    companion object {
        ...
        internal fun free(buf: RustBuffer.ByValue) = uniffiRustCall() { status ->
            UniffiLib.ffi_walkie_talkie_engine_rustbuffer_free(buf, status)
        }
    }
...
internal open class UniffiVTableCallbackInterfacePacketTransport(
    ...
    @JvmField internal var `sendPacket`: UniffiCallbackInterfacePacketTransportMethod0? = null,
) : Structure() {
    class UniffiByValue(
...
private fun uniffiCheckContractApiVersion(lib: IntegrityCheckingUniffiLib) {
    ...
    val scaffolding_contract_version = lib.ffi_walkie_talkie_engine_uniffi_contract_version()
    ...
    private class UniffiCleanAction(private val handle: Long) : Runnable {
        override fun run() {
            ...
            uniffiRustCall { status ->
                UniffiLib.uniffi_walkie_talkie_engine_fn_free_audioengine(handle, status)
            }
        }
    }
...
internal object uniffiCallbackInterfacePacketTransport {
    ...
    internal var vtable = UniffiVTableCallbackInterfacePacketTransport.UniffiByValue(
        uniffiFree,
        uniffiClone,
        `sendPacket`,
    )
    ...
    internal fun register(lib: UniffiLib) {
        lib.uniffi_walkie_talkie_engine_fn_init_callback_vtable_packettransport(vtable)
    }
}
